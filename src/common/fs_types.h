...
#define FS_SERVER_STATUS_RECOVERY_FLAG  1

#define FS_SERVER_STATUS_INIT       0
#define FS_SERVER_STATUS_OFFLINE    2
#define FS_SERVER_STATUS_ONLINE     4
#define FS_SERVER_STATUS_ACTIVE     8
#define FS_SERVER_STATUS_REBUILDING (FS_SERVER_STATUS_INIT | FS_SERVER_STATUS_RECOVERY_FLAG)
#define FS_SERVER_STATUS_RECOVERING (FS_SERVER_STATUS_OFFLINE | FS_SERVER_STATUS_RECOVERY_FLAG)
