...
BuildRequires: libserverframe-devel >= 1.2.8
BuildRequires: libdiskallocator-devel >= 1.1.12
...
Requires: libaio
Requires: libserverframe >= 1.2.8
Requires: libfastrdma >= 1.0.7
Requires: libfsstorage >= 1.1.12
